...
\input{Tables/sirs_alb_pvalues}

\input{Tables/sirs_neut}
\input{Tables/sirs_neut_pvalues}
...
\end{figure}
\input{Tables/sirs_crp_with_alb}
\clearpage
%==============================================================================
...
\input{Tables/sirs_bodycomp_crp}
\input{Tables/sirs_bodycomp_alb}
\input{Tables/sirs_bodycomp_neut}
...
The results presented in this study emphasise the importance of the preoperative inflammatory status of the patient in influencing postoperative systemic inflammation. The results also demonstrate the immunosuppressive effects of obstructive jaundice in these patients. 




%Limitations
%no multivariate analysys
%potential confounding factors
%impact of surgical factors, complicaitons, etc
