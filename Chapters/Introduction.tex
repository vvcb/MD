...
In patients with resectable disease, surgery \parencite{sener_pancreatic_1999, sohn_resected_2000,geer_prognostic_1993} followed by adjuvant chemotherapy \parencite{neoptolemos_randomized_2004, neoptolemos_adjuvant_2009} offers the only chance of a cure. 
...
A roof-top incision was made to enter the abdominal cavity. 
...
Gstro-jejunostomy or duodenojejunostomy (in PPPD) was performed using continuous 3/0 Polydioxanone (PDS) sutures in 2-layers. 
...
Selection of patients suitable for potentially curative surgery not only depends on the resectability criteria that were discussed in section \ref{sec:resectability_criteria} but also on patient fitness \parencite{bilimoria_national_2007, sandroussi_sociodemographics_2010}. 
...
It can result in a worse outcome for the patient due to either post-operative mortality or prolonged hospitalisation due to complications resulting in poor quality of life with little difference in survival when compared to palliation. 
...
The physiology component of the POSSUM score (POSSUM Physiology Score, PPS) which takes into account both comorbidity and specific preoperative biochemical parameters was used as an objective static measure of comorbidity in this thesis. 
...
As the Glasgow Coma Scale in all patients undergoing pancreaticoduodenectomy was 15, this variable was excluded in the calculation of the score in this thesis.

\input{Tables/c1_possum}
...
\subsection{Respiratory exchange ratio}
The ratio of $\dot{V}_{CO_2}/\dot{V}_{O_2}$ is called the Respiratory Exchange Ratio (RER). 
...
\subsection{Ventilatory equivalents}
The changes in the ventilatory equivalents for $O_2$ ($\dot{V}_E/\dot{V}_{O_2}$) and $CO_2$ ($\dot{V}_E/\dot{V}_{CO_2}$) during exercise provide valuable information regarding the ventilatory response to exercise. 
...
\subsection{End-tidal oxygen and CO2} 
...
In healthy individuals, breathing frequency ($B_f$) is one of the most important respiratory responses to exercise in order to increase oxygen uptake. 
...
Older and co-workers first reported on the value of cardiopulmonary exercise testing for preoperative risk assessment in a prospective study of 187 patients over the age of 60 undergoing major abdominal surgery  \parencite{older_preoperative_1993}. 
