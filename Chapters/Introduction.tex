...
Pancreatic ductal adenocarcinoma is the most common cancer of the pancreas. However, the head of the pancreas is anatomically related to several other epithelium lined structures that can also give rise to cancers. These include the distal common bile duct (cholangiocarcinoma), the duodenum (duodenal adenocarcinoma) and the ampulla (ampullary adenocarcinoma). Neuroendocrine tumours (NET) are a collection of a variety of neoplasia that originate from the endocrine portion of the pancreas. This milieu is complicated by other neoplasia such as intra-ductal papillary neoplasms (IPMN) as well as rare stromal tumours. Occasionally, chronic pancreatitis may present with features similar to pancreatic cancer and can be morphologically, radiologically and histologically difficult to differentiate from cancer.
