...
\lhead{Chapter \ref{ch_survival}. \emph{CPET, Comorbidity and Survival}} % This is for the header on each page - perhaps a shortened title

\clearpage
%----------------------------------------------------------------------------------------

\todo{Should complications-survival also be included in this chapter?}
...
\input{Tables/cpet_survival_cox_regression}
\input{Tables/cpet_survival_cox_tumour_factors}
...
\input{Tables/cpet_survival_6months}
\input{Tables/cpet_survival_12months}
\input{Tables/cpet_survival_24months}
...
%Lack of assocation with CPET

%Tumour factors trump comorbidity

Overall median survival in this study was [\todo{pending result}? months] which is considerably shorter than that reported in other studies on the impact of comorbidty on long-term survival. The short median survival is a consequence of the aggressive nature of pancreatic ductal adenocarcinoma and is similar to previously published literature. [\todo{pending reference}] This is also demonstrated in Table \ref{table:cpet_survival_cox_tumour_factors}. This 


%Discuss limitations
% - Small numbers
% - Selection bias - patients with significant comorbidity would have not been offered surgery
% - No information on adjuvant therapy 
