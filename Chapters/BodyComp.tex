...
Anaemia (haemoglobin $<$ 12 g/dl) was associated with increased adiposity in the subcutaneous plane and reduced skeletal muscle area. 
	%\input{Tables/bc_sex_specific_distrib}
	%\input{Tables/bc_clinical}
	\input{Tables/c4_t1}
\clearpage
...
Skeletal Muscle}
	...
	\caption*{%Scatter-plots were generated comparing absolute $\dot{V}_{O_2}$ (litres/minute, solid lines) and $\dot{V}_{O_2}$ normalised for total body weight (corrected $\dot{V}_{O_2}$, ml/kg/min, dotted lines) against skeletal muscle area (A) and total adipose tissue area (B).
...
\input{Tables/bc_at_new_indices}
