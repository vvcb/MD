...
\todo{Aim does not tie up with primary end-points - fix this.}
\clearpage
...
\todo{These numbers don't add up - check them.}
...
\includegraphics[width=\textwidth]{Figures/cpet_outcomes_km_at_los_table} %Table below Kaplan Meier curve
...
\todo{Remove unjustified/unsupported conclusion}
\todo{Remove GPS conclusion}
