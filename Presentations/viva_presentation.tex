...
\begin{frame}
	...
	\begin{itemize}
		\item 10th most common cancer
		\item 5th most common cause of cancer death
		\item 1-year survival	: 20.8\%
		\item 5-year survival	: 3.3\%
		\item 10-year survival	: 1.1\%	
		\medskip
		\item Operable disease : ~ 15\%
	\end{itemize}
\end{frame}

\begin{frame}
	\frametitle{Management of Pancreatic Cancer} 
	\begin{itemize}
		\item Surgery is the primary modality of cure
		\item Adjuvant chemotherapy has an important role in improving survival
		\item Pancreaticoduodenectomy (Whipple's procedure)
		\begin{itemize}
			\item Complex surgery with 50\% morbidity
			\item Patient fitness as important as tumour factors
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	\frametitle{Outcomes after major pancreatic surgery} 
